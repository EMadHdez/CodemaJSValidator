class JSValidator{
    ...
    constructor (formId) { 
    //Llamamos los metodos desde el constructor
    this.setForm(formId);
    this.setInputs();
    this.parseInputs();
    ...
    setForm(formId){
     ...
     //Metodo para analizar cada input
     parseInputs(){
     ...
     appendErrorsTag(input){
        ...
        //Definimos atributo de la etiqueta
     ...
     validateForm() {
		...
		this.form.addEventListener('submit', (e) => {
			...
			// Reiniciamos los errores y cambiar status a true
			...
			if(!this.status) {
				...
				// Analizamos si se debe enviar por ajax o http
				if(this.via == 'ajax'){
